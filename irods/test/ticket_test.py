...
class TestTicketOps(unittest.TestCase):
    ...
    def test_data_ticket_read(self):
        self._ticket_read_helper(obj_type="data")

    def test_coll_ticket_read(self):
        self._ticket_read_helper(obj_type="coll")

    def test_data_ticket_read_with_download(self):
        self._ticket_read_helper(obj_type="data", download=True)

    def test_coll_ticket_read_with_download(self):
        self._ticket_read_helper(obj_type="coll", download=True)
    ...
    def test_data_ticket_write(self):
        self._ticket_write_helper(obj_type="data")
