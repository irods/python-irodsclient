...
class Session(object):
    ...
    @property
    def connection(self):
        return self.pool.get_connection() # -> sets and returns self.conn

    @property
    def server_version(self):
        return self.connection.server_version

    # Provide a pool property so that we can act like an old-style iRODSSession
    ...
    @property
    def username(self):
        return self.account.client_user

    @property
    def zone(self):
        return self.account.client_zone
    ...
    def host(self,host_name):
        self.account.host = host_name

    @property
    def port(self):
        return self.account.port
...
'''
    ...
    def default_resource(self):
        return self.account.default_resource

    @default_resource.setter
    def default_resource(self, name):
        self.account.default_resource = name
    ...
    def get_irods_password(session_ = None, file_path_if_not_found = (), **kwargs):
        ...
        try:
            ...
            irods_auth_file = Session.get_irods_password_file()
...
class Connection(object):
    ...
    def __init__(self, account):
        ...
        self.application_name = "PRC_mk_II"
        self.socket = None
    ...
    def _connect(self):
        ...
        timeout = None
        #timeout = self.pool.connection_timeout # dwm - PRC mk 2
